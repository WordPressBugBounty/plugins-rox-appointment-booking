...
namespace RoxAppointmentBookingVendors\Stripe\Treasury;
 ...
 */
class FinancialAccount extends \RoxAppointmentBookingVendors\Stripe\ApiResource
{
    const OBJECT_NAME = 'treasury.financial_account';
    use \RoxAppointmentBookingVendors\Stripe\ApiOperations\Update;
    ...
    public static function create($params = null, $options = null)
    {
        ...
        $obj = \RoxAppointmentBookingVendors\Stripe\Util\Util::convertToStripeObject($response->json, $opts);
    ...
    {
        $url = static::classUrl();
        return static::_requestPage($url, \RoxAppointmentBookingVendors\Stripe\Collection::class, $params, $opts);
    }
    /**
    ...
    {
        $opts = \RoxAppointmentBookingVendors\Stripe\Util\RequestOptions::parse($opts);
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \RoxAppointmentBookingVendors\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
        return $obj;
    }
    /**
