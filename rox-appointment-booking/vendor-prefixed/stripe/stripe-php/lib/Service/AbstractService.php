...
abstract class AbstractService
{
    ...
    {
        $apiMode = \RoxAppointmentBookingVendors\Stripe\Util\Util::getApiMode($path);
        $params = self::formatParams($params, $apiMode);
        if (null !== $schemas && isset($schemas['request_schema'])) {
            $params = \RoxAppointmentBookingVendors\Stripe\Util\Int64::coerceRequestParams($params, $schemas['request_schema']);
        }
