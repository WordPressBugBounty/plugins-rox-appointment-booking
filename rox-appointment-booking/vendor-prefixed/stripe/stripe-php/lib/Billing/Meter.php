...
namespace RoxAppointmentBookingVendors\Stripe\Billing;
 ...
 */
class Meter extends \RoxAppointmentBookingVendors\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';
    use \RoxAppointmentBookingVendors\Stripe\ApiOperations\NestedResource;
