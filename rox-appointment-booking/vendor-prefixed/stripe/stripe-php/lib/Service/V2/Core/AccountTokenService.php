...
namespace RoxAppointmentBookingVendors\Stripe\Service\V2\Core;
 ...
 */
class AccountTokenService extends \RoxAppointmentBookingVendors\Stripe\Service\AbstractService
{
    /**
    ...
    {
        return $this->request('post', '/v2/core/account_tokens', $params, $opts, ['request_schema' => ['kind' => 'object', 'fields' => ['identity' => ['kind' => 'object', 'fields' => ['individual' => ['kind' => 'object', 'fields' => ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]]]]]]]]);
    }
    /**
