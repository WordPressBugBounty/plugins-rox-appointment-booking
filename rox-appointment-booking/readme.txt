...
* Improved: Internal dashboard notification UI/UX.
* Improved: Booking Panel Gutenberg block and Elementor widget UI.
* Improved: All forms validation proccess.
* Improved: Back to Wordpress option UI/UX.

Version: 1.0.5 // 2026-07-01
* Added: Holidays and Special Days settings new design.
* Added: Custom Fields for the booking form.
* Added: Configurable built-in customer fields.
* Added: Custom field values on the Order view and confirmation email.

Version: 1.0.4 // 2026-06-29
* Improved: Agent module and onboarding workflow.
* Improved: Booking panel settings in the admin dashboard.
* Improved: Search functionality across all tables in the admin dashboard.
* Improved: Order module UI.

Version: 1.0.3 // 2026-06-24
* Added: Coupon management system in the dashboard with coupon apply functionality during booking.

Version: 1.0.2 // 2026-06-23
* Added: Booking Panel Elementor widget.
* Added: Support for creating multiple Locations, Agents, Categories, and Services during onboarding.
* Improved: Onboarding UI/UX.
* Improved: Order details view refreshed with an updated layout.
* Improved: Consolidated multiple module tables into a single unified table for consistent handling across all modules.
* Improved: Refreshed the table UI for better clarity and visual consistency.
* Fixed: Previously opened drawer state was not restored after page reload.

Version: 1.0.1 // 2026-06-18
* Added: Booking panel Gutenberg block with layout options.
* Added: Internal dashboard notification system.
* Improved: Order view UI.
* Improved: Appointment query performance for faster loading and better efficiency.
* Fixed: Available timeslots not showing when the user is not logged in.
