 ...
 */
class AccountPerson extends \RoxAppointmentBookingVendors\Stripe\ApiResource
{
    const OBJECT_NAME = 'v2.core.account_person';
    public static function fieldEncodings()
    {
        return ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]];
    }
