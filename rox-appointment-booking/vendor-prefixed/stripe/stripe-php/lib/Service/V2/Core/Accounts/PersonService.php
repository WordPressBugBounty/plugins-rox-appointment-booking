...
namespace RoxAppointmentBookingVendors\Stripe\Service\V2\Core\Accounts;
 ...
 */
class PersonService extends \RoxAppointmentBookingVendors\Stripe\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', $this->buildPath('/v2/core/accounts/%s/persons', $id), $params, $opts, ['response_schema' => ['kind' => 'object', 'fields' => ['data' => ['kind' => 'array', 'element' => ['kind' => 'object', 'fields' => ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]]]]]]]);
    }
    /**
    ...
    {
        return $this->request('post', $this->buildPath('/v2/core/accounts/%s/persons', $id), $params, $opts, ['request_schema' => ['kind' => 'object', 'fields' => ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]]], 'response_schema' => ['kind' => 'object', 'fields' => ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]]]]);
    }
    /**
    ...
    {
        return $this->request('get', $this->buildPath('/v2/core/accounts/%s/persons/%s', $parentId, $id), $params, $opts, ['response_schema' => ['kind' => 'object', 'fields' => ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]]]]);
    }
    /**
    ...
    {
        return $this->request('post', $this->buildPath('/v2/core/accounts/%s/persons/%s', $parentId, $id), $params, $opts, ['request_schema' => ['kind' => 'object', 'fields' => ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]]], 'response_schema' => ['kind' => 'object', 'fields' => ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]]]]);
    }
}
