...
abstract class Webhook
{
    ...
    public static function constructEvent($payload, $sigHeader, $secret, $tolerance = self::DEFAULT_TOLERANCE)
    {
        ...
        if (isset($data['object']) && 'v2.core.event' === $data['object']) {
            throw new Exception\UnexpectedValueException('You passed an event notification to Webhook::constructEvent, which expects a webhook payload. Use StripeClient::parseEventNotification instead.');
        }
