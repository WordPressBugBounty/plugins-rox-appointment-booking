    ...
    protected function getServiceData(ServiceModel $service, bool $detailed = false, string $mode = 'default'): array
    {
        ...
        if ($detailed) {
            $data = array_merge($data, [
                ...
                'minimum_advance_enable' => $service->minimum_advance_enable ? ['1'] : [],
                'minimum_advance_days' => $service->minimum_advance_days,
                'minimum_advance_hours' => $service->minimum_advance_hours,
                'maximum_advance_enable' => $service->maximum_advance_enable ? ['1'] : [],
                'maximum_advance_days' => $service->maximum_advance_days,
                'maximum_advance_hours' => $service->maximum_advance_hours,
