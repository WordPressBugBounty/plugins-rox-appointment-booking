 ...
 */
class PersonTokenService extends \RoxAppointmentBookingVendors\Stripe\Service\AbstractService
{
    /**
    ...
    {
        return $this->request('post', $this->buildPath('/v2/core/accounts/%s/person_tokens', $id), $params, $opts, ['request_schema' => ['kind' => 'object', 'fields' => ['relationship' => ['kind' => 'object', 'fields' => ['percent_ownership' => ['kind' => 'decimal_string']]]]]]);
    }
    /**
