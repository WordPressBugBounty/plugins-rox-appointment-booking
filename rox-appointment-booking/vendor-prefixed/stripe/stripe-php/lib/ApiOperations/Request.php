...
namespace RoxAppointmentBookingVendors\Stripe\ApiOperations;
...
trait Request
{
    ...
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            ...
            throw new \RoxAppointmentBookingVendors\Stripe\Exception\InvalidArgumentException($message);
        }
    }
    /**
    ...
    protected static function _requestPage($url, $resultClass, $params = null, $options = null, $usage = [])
    {
        ...
        if (!$obj instanceof $resultClass) {
            throw new \RoxAppointmentBookingVendors\Stripe\Exception\UnexpectedValueException('Expected type ' . $resultClass . ', got "' . \get_class($obj) . '" instead.');
        }
    ...
    {
        $opts = \RoxAppointmentBookingVendors\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \RoxAppointmentBookingVendors\Stripe\ApiRequestor($opts->apiKey, $baseUrl);
