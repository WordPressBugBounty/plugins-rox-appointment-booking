...
namespace RoxAppointmentBookingVendors\Stripe\V2;
 ...
 */
class Collection extends \RoxAppointmentBookingVendors\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \RoxAppointmentBookingVendors\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \RoxAppointmentBookingVendors\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function offsetGet($k)
    {
        ...
        throw new \RoxAppointmentBookingVendors\Stripe\Exception\InvalidArgumentException($msg);
    }
    /**
    ...
    public function autoPagingIterator()
    {
        ...
        while (\true) {
            ...
            $obj = \RoxAppointmentBookingVendors\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
