...
namespace RoxAppointmentBookingVendors\Stripe;

use RoxAppointmentBookingVendors\Stripe\Util\Util;
use RoxAppointmentBookingVendors\Stripe\V2\Core\EventNotification;
class BaseStripeClient implements StripeClientInterface, StripeStreamingClientInterface
{
    ...
    const DEFAULT_CONFIG = [
        ...
        'stripe_account' => null,
        'stripe_context' => null,
        'stripe_version' => \RoxAppointmentBookingVendors\Stripe\Util\ApiVersion::CURRENT,
    ...
    public function __construct($config = [])
    {
        ...
        $this->config = $config;
        $this->defaultOpts = \RoxAppointmentBookingVendors\Stripe\Util\RequestOptions::parse(['stripe_account' => $config['stripe_account'], 'stripe_context' => $config['stripe_context'], 'stripe_version' => $config['stripe_version'], 'max_network_retries' => $config['max_network_retries']]);
    }
    /**
